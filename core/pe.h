...
typedef struct _IMAGE_LOAD_CONFIG_CODE_INTEGRITY2 {
...
} IMAGE_LOAD_CONFIG_CODE_INTEGRITY2, *PIMAGE_LOAD_CONFIG_CODE_INTEGRITY2;
...
typedef struct _IMAGE_LOAD_CONFIG_DIRECTORYEX32 {
	...
	DWORD   GuardFlags;
	IMAGE_LOAD_CONFIG_CODE_INTEGRITY2 CodeIntegrity;
